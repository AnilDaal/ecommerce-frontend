...
const Security = () => {
  return (
    ...
    >
      ...
      <p>
        Yes! We accept VISA, MasterCard, Maestro, American Express credit/debit
        cards issued by banks in India and in the following countries:
        Australia, Austria, Belgium, Canada, Cyprus, Denmark, Finland, France,
        Germany, Ireland, Italy, Luxembourg, the Netherlands, New Zealand,
        Norway, Portugal, Singapore, Spain, Sweden, the UK and the US. Please
        note that we do not accept internationally issued credit/debit cards for
      ...
      <p>
        ...
        Installments (EMI), E-Gift Vouchers, PhonePe UPI and PhonePe wallet.
      </p>
      ...
      <p>Couldn't find the information you need? Please Contact Us</p>
    </div>
  );
};
