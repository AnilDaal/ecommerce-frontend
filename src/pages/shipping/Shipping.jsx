...
const Shipping = () => {
  return (
    ...
    >
      <h2>Shipping What are the delivery charges?</h2>
      ...
      <p>
        For Products listed as FurnitureLelo Plus, a Rs 40 charge for delivery
        per item may be applied if the order value is less than Rs 500. While,
      ...
      <p>
        The Seller offering the product Product's availability with the Seller
        The destination to which you want the order shipped to and location of
        the Seller. Are there any hidden costs (sales tax, octroi etc) on items
        sold by Sellers on FurnitureLelo?
      </p>
      ...
      <h2>Seller does not/cannot ship to my area. Why?</h2>
      ...
      <p>
        ...
        shipping particular products to your location The availability of
        reliable courier partners in your location At times Sellers prefer not
        to ship to certain locations. This is entirely at their discretion.
      </p>

      <p>Why is the CoD option not offered in my location?</p>
      ...
      <h2>
        What do the different tags like &quot;In Stock&quot;,
        &quot;Available&quot; mean?
      </h2>
      ...
      <p>
        ...
        delivery time based on your location pincode (usually 2-3 business days,
        4-5 business days or 4-6 business days in areas where standard courier
      ...
      <h2>'Preorder' or 'Forthcoming'</h2>

      <p>
        Such items are expected to be released soon and can be pre-booked for
        you. The item will be shipped to you on the day of it's official release
      ...
      <p>
        ...
        The product could to be in stock soon. Use the 'Notify Me' feature to
        know when it is available for purchase.
      </p>

      <h2>'Permanently Discontinued'</h2>
      ...
      <h2>
        Does FurnitureLelo deliver internationally? As of now, FurnitureLelo
        doesn't deliver items internationally.
      </h2>

      <p>
        You will be able to make your purchases on our site from anywhere in the
        world with credit/debit cards issued in India and 21 other countries,
        but please ensure the delivery address is in India.
      </p>
